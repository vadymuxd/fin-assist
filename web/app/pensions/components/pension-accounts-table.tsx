...
type SortKey     = "provider" | "account_name" | "balance_gbp";
type OwnerFilter = "All" | "Vadym" | "Lisa";
const OWNER_FILTERS: OwnerFilter[] = ["All", "Vadym", "Lisa"];
...
export default function PensionAccountsTable({ accounts }: { accounts: PensionAccount[] }) {
  ...
  const filtered = useMemo(() => {
    ...
    const target = ownerFilter.toLowerCase();
